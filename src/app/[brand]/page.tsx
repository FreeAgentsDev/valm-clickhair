      ...
      <main className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        >
          <div className="flex flex-col sm:flex-row items-center gap-6">
            <div className="relative h-24 w-24 shrink-0 rounded-full overflow-hidden bg-white/20 shadow-lg ring-2 ring-white/30">
              <Image
                src={brandInfo.logo}
                alt={brandInfo.name}
                fill
            ...
            <div className="text-center sm:text-left">
              <h1 className="text-3xl font-bold sm:text-4xl drop-shadow-sm">
                {brandInfo.name}
              </h1>
              ...
              <a
                ...
                className="mt-4 inline-flex items-center gap-2 rounded-lg bg-white/25 px-4 py-2 text-sm font-medium hover:bg-white/35 transition-colors backdrop-blur"
              >
                @{brandInfo.instagram}
              </a>
            </div>
